"""Forecasting Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Business forecasting agent that builds time-series forecasts, combines statistical and ML methods, quantifies prediction uncertainty, detects seasonality, and provides demand planning and capacity forecasts.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
